  ...
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    >
      ...
      >
        ...
        <img className="w-full sm:h-[500px] h-[350px] object-cover rounded-tl-[140px] z-10 relative" src="/cover.png" alt="cover" />
        <a href="#explore">
          <div className="w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-[40px] relative z-10">
            <img className="sm:w-[155px] w-[100px] sm:h-[155px] h-[100px] object-contain" src="/stamp.png" alt="stamp" />
          </div>
        </a>
      </motion.div>
    </motion.div>
